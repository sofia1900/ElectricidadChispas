public class InvoicePrinter {
    public void print(Invoice invoice){
        ...
        double total = 0.0; // variable para ir acomulando el valor total
        ...
        for (Integer i = 0 ; i < invoice.getProduct().size() ; i++){
            System.out.println(invoice.getProduct().get(i).getCode() + " | " + invoice.getProduct().get(i).getName() + " | " +
                    ...
                    invoice.getProduct().get(i).getVatRate().getValue()* invoice.getProduct().get(i).getPrice()/100);
            total = total + invoice.getProduct().get(i).getVatRate().getValue()* invoice.getProduct().get(i).getPrice()/100;
        }
        for (Integer i = 0 ; i < invoice.getServices().size() ; i++){
            System.out.println(invoice.getServices().get(i).getCode() + " | " + invoice.getServices().get(i).getName() + " | " +
                    ...
                    invoice.getServices().get(i).getVatRate().getValue()* invoice.getServices().get(i).getPrice()/100);
            total = total + invoice.getServices().get(i).getVatRate().getValue()* invoice.getServices().get(i).getPrice()/100;
        }
